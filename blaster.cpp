...
void Blaster::drawblaster(SDL_Renderer * renderer,int tubeQuad[4][2])
{
    std::vector<float> posRimFlexible = this->utils->WeightedMidpoint(tubeQuad[0],tubeQuad[1],15);
    std::vector<float> posRimLeft = this->utils->WeightedMidpoint(tubeQuad[0],tubeQuad[1],0.9);
